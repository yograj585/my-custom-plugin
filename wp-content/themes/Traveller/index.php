...
?>
                ...
                <div class="row">
                  <div class="col-md-7">
                    <div class="detail-box">
                      <div>
                        <h1>
                            <?php $field = get_field('banner_name',7); echo $field; ?>
  ...
  <section class="how_section layout_padding">
    <div class="heading_container">
      <h2>
        <?php echo get_field('section_banner',7); ?>
      </h2>
    </div>
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <div class="download_box">
              ...
              <div class="btn-box">
                <a href="">
                  <img src="<?php echo get_template_directory_uri(); ?>/images/app-store.png" alt="">
                </a>
                <a href="">
                  <img src="<?php echo  get_template_directory_uri(); ?>/images/play-store.png" alt="">
                </a>
              </div>
            </div>
          </div>
  ...
  <section class="auto_section layout_padding">
    <div class="container">
      ...
      <div class="box">
        <div class="img-box">
          <img src="<?php echo get_template_directory_uri(); ?>/images/auto-img.png" alt="">
        </div>
        <div class="detail-box">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_contact">
            ...
            <div>
              <div class="img-box">
                <img src="<?php echo get_template_directory_uri(); ?>/images/location.png" width="18px" alt="" />
              </div>
              <p>
            ...
            <div>
              <div class="img-box">
                <img src="<?php echo  get_template_directory_uri(); ?>/images/phone.png" width="18px" alt="" />
              </div>
              <p>
                +01 1234567890
              </p>
            ...
            <div>
              <div class="img-box">
                <img src="<?php echo get_template_directory_uri(); ?>/images/envelope.png" width="18px" alt="" />
              </div>
              <p>
                demo@gmail.com
              </p>
